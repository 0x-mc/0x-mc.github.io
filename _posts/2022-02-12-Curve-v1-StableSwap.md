...
<!-- <img src="https://render.githubusercontent.com/render/math?math=\chi=\frac{A\Pi x_i}{(D/n)^n}" /> -->

代入可得最终的核心公式

$An^n\Sigma x_i + D = ADn^n + \frac{D^{n+1}}{n^n\Pi x_i}$
<!-- <img src="https://render.githubusercontent.com/render/math?math=An^n\Sigma x_i%2BD = ADn^n%2B\frac{D^{n%2B1}}{n^n\Pi x_i}" /> -->
...
1. 首先将核心公式变形成 `f(D) = 0` 的形式
   ...
   <!-- <img src="https://render.githubusercontent.com/render/math?math=f(D)=An^n\Sigma x_i%2BD-ADn^n-\frac{D^{n%2B1}}{n^n\Pi x_i}" /> -->

2. `D_new = D - f(D)/f'(D)`

    $D_{new}=D-\frac{An^n\Sigma x_i + D-ADn^n-\frac{D^{n+1}}{n^n\Pi x_i}}{1-An^n}$
   <!-- <img src="https://render.githubusercontent.com/render/math?math=D_{new}=D-\frac{An^n\Sigma x_i%2BD-ADn^n-\frac{D^{n%2B1}}{n^n\Pi x_i}}{1-An^n}" /> -->
...
3. 最终变成代码注释中的形态
   ...
   <!-- <img src="https://render.githubusercontent.com/render/math?math=D_{new}=\frac{An^n\Sigma x_i-\frac{D^{n%2B1}}{n^n\Pi x_i}}{An^n-1}" /> -->
